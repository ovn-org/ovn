...
#define OFTABLE_SHARED_MAC_BINDING        113
#define OFTABLE_SHARED_MAC_LOOKUP         114
#define OFTABLE_MAC_BINDING_OVERRIDE      115
#define OFTABLE_MAC_LOOKUP_OVERRIDE       116
